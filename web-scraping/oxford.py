...
class Oxford:
    ...
    def __init__(self, word):
        ...
        self.get_word_type()
        self.get_word_level()
        # self.word_level = self.get_word_level()
    ...
    def clear_extra_examples(self):
        try:
            self.soup.find("span", unbox="extra_examples").clear() #extra_examples_removed
    ...
    def get_examples(self):
        try:
            ...
            definitions_html = self.soup.find("ol", class_="senses_multiple")
            examples_html = definitions_html.find_all("ul", class_="examples", hclass="examples")
    ...
    def get_ipa(self, phon="nam"):
        try:
            self.ipa_nam = self.soup.find("div", class_="phons_n_am").text
            self.ipa_br = self.soup.find("div", class_="phons_br").text
